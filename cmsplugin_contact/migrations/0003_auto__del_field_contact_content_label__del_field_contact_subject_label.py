...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('cmsplugin_contact', 'content_label')

        # Deleting field 'Contact.subject_label'
        db.delete_column('cmsplugin_contact', 'subject_label')

        # Deleting field 'Contact.email_label'
        db.delete_column('cmsplugin_contact', 'email_label')

        # Deleting field 'Contact.submit'
        db.delete_column('cmsplugin_contact', 'submit')


    def backwards(self, orm):
        
        # Adding field 'Contact.content_label'
        db.add_column('cmsplugin_contact', 'content_label', self.gf('django.db.models.fields.CharField')(default=u'Message', max_length=100), keep_default=False)

        # Adding field 'Contact.subject_label'
        db.add_column('cmsplugin_contact', 'subject_label', self.gf('django.db.models.fields.CharField')(default=u'Subject', max_length=200), keep_default=False)

        # Adding field 'Contact.email_label'
        db.add_column('cmsplugin_contact', 'email_label', self.gf('django.db.models.fields.CharField')(default=u'Your email address', max_length=100), keep_default=False)

        # Adding field 'Contact.submit'
        db.add_column('cmsplugin_contact', 'submit', self.gf('django.db.models.fields.CharField')(default=u'Submit', max_length=30), keep_default=False)
